  ...
  vocab = data.map(item => ({
    ...
    function checkAnswer() {
      ...
      if (mode === "ar2en") {
        ...
        if (user === key) { correct = true; score += 1; if (autoNextEl.checked) {
